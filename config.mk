...
CFLAGS=-DFT_OS_LINUX  -fPIC
INCLUDES=
LIBS_PATHS=
LIBS=
OBJS_PATH=./objs
SRCS=./srcs/paths/ft_path_clean.c ./srcs/paths/ft_path_parse.c ./srcs/exec/run.c ./srcs/exec/init.c ./srcs/exec/edit.c ./srcs/exec/inject.c ./srcs/time/ft_strtime.c ./srcs/time/ft_timer.c ./srcs/debug/ft_debug.c ./srcs/debug/ft_memcheck.c ./srcs/getopt/getopt.c ./srcs/libft.c ./srcs/arrays/ft_array.c ./srcs/std/ft_rand.c ./srcs/std/ft_str_isdigit.c ./srcs/std/ft_hash.c ./srcs/std/ft_memchr.c ./srcs/std/ft_range.c ./srcs/std/ft_atoix.c ./srcs/std/ft_memset.c ./srcs/std/ft_sort.c ./srcs/std/ft_str_isascii.c ./srcs/std/ft_str_isalpha.c ./srcs/std/ft_itoa.c ./srcs/std/ft_atoi.c ./srcs/std/ft_str_isalnum.c ./srcs/std/ft_memcpy.c ./srcs/std/ft_ftoa.c ./srcs/std/ft_memdup.c ./srcs/std/f32_inf_nan.c ./srcs/std/ft_nrange.c ./srcs/std/ft_memcmp.c ./srcs/std/ft_str_isprint.c ./srcs/std/char_checks.c ./srcs/std/ft_memmove.c ./srcs/std/ft_setenv.c ./srcs/std/ft_utoa.c ./srcs/std/ft_str_iswhitespace.c ./srcs/std/ft_bzero.c ./srcs/std/ft_atof.c ./srcs/fileio/ft_putchar_fd.c ./srcs/fileio/ft_fread.c ./srcs/fileio/ft_readfile.c ./srcs/fileio/ft_fmode.c ./srcs/fileio/ft_putendl_fd.c ./srcs/fileio/ft_fopen.c ./srcs/fileio/ft_putnbr_fd.c ./srcs/fileio/ft_fclose.c ./srcs/fileio/ft_putstr_fd.c ./srcs/fileio/ft_printf/arg_table.c ./srcs/fileio/ft_printf/printf_internal.c ./srcs/fileio/ft_printf/ft_printf.c ./srcs/fileio/ft_printf/parse.c ./srcs/fileio/gnl/ft_gnl.c ./srcs/fileio/ft_fwrite.c ./srcs/maths/trigo.c ./srcs/maths/vec_div.c ./srcs/maths/vec_mul.c ./srcs/maths/vec_mod.c ./srcs/maths/ft_noise2.c ./srcs/maths/wrap.c ./srcs/maths/ft_frand.c ./srcs/maths/lerp.c ./srcs/maths/ft_max.c ./srcs/maths/normalize.c ./srcs/maths/ft_is_prime.c ./srcs/maths/ft_matrix.c ./srcs/maths/ft_min.c ./srcs/maths/abs.c ./srcs/maths/ceil.c ./srcs/maths/distance.c ./srcs/maths/ft_rand_circle.c ./srcs/maths/smoothstep.c ./srcs/maths/frac.c ./srcs/maths/ft_dist_line.c ./srcs/maths/vec_init.c ./srcs/maths/clamp.c ./srcs/maths/ft_magnitude.c ./srcs/maths/ft_isrange.c ./srcs/maths/vec_add.c ./srcs/maths/rotate.c ./srcs/maths/ft_map.c ./srcs/maths/ft_pow.c ./srcs/maths/dot.c ./srcs/maths/vec_scale.c ./srcs/maths/vec_sub.c ./srcs/maths/cross.c ./srcs/lists/ft_lstsize.c ./srcs/lists/ft_lstclear.c ./srcs/lists/ft_lstnew.c ./srcs/lists/ft_lstsort.c ./srcs/lists/ft_lstiter.c ./srcs/lists/ft_lsttoarray.c ./srcs/lists/ft_lstadd_front.c ./srcs/lists/ft_lstadd_back.c ./srcs/lists/ft_lstfind.c ./srcs/lists/ft_lstlast.c ./srcs/lists/ft_lstremoveif.c ./srcs/lists/ft_lstmap.c ./srcs/lists/ft_lstdelone.c ./srcs/lists/ft_lstremove.c ./srcs/strings/ft_dupsplit.c ./srcs/strings/ft_strgetindex.c ./srcs/strings/ft_strtrim.c ./srcs/strings/ft_freesplit.c ./srcs/strings/ft_strncmp.c ./srcs/strings/ft_striteri.c ./srcs/strings/ft_strchr.c ./srcs/strings/ft_splitlen.c ./srcs/strings/ft_strnstr.c ./srcs/strings/ft_strjoin.c ./srcs/strings/ft_split.c ./srcs/strings/ft_strlcpy.c ./srcs/strings/ft_strmapi.c ./srcs/strings/ft_str_append.c ./srcs/strings/ft_str_toupper.c ./srcs/strings/ft_strnchr.c ./srcs/strings/ft_strlcat.c ./srcs/strings/ft_strcmp.c ./srcs/strings/ft_tolower.c ./srcs/strings/ft_strdup.c ./srcs/strings/ft_strerror.c ./srcs/strings/ft_str_tolower.c ./srcs/strings/ft_strlen.c ./srcs/strings/ft_substr.c ./srcs/strings/ft_strcat.c ./srcs/strings/ft_strrchr.c ./srcs/strings/ft_toupper.c ./srcs/strings/pad.c
OBJS=./objs/ft_path_clean.o ./objs/ft_path_parse.o ./objs/run.o ./objs/init.o ./objs/edit.o ./objs/inject.o ./objs/ft_strtime.o ./objs/ft_timer.o ./objs/ft_debug.o ./objs/ft_memcheck.o ./objs/getopt.o ./objs/libft.o ./objs/ft_array.o ./objs/ft_rand.o ./objs/ft_str_isdigit.o ./objs/ft_hash.o ./objs/ft_memchr.o ./objs/ft_range.o ./objs/ft_atoix.o ./objs/ft_memset.o ./objs/ft_sort.o ./objs/ft_str_isascii.o ./objs/ft_str_isalpha.o ./objs/ft_itoa.o ./objs/ft_atoi.o ./objs/ft_str_isalnum.o ./objs/ft_memcpy.o ./objs/ft_ftoa.o ./objs/ft_memdup.o ./objs/f32_inf_nan.o ./objs/ft_nrange.o ./objs/ft_memcmp.o ./objs/ft_str_isprint.o ./objs/char_checks.o ./objs/ft_memmove.o ./objs/ft_setenv.o ./objs/ft_utoa.o ./objs/ft_str_iswhitespace.o ./objs/ft_bzero.o ./objs/ft_atof.o ./objs/ft_putchar_fd.o ./objs/ft_fread.o ./objs/ft_readfile.o ./objs/ft_fmode.o ./objs/ft_putendl_fd.o ./objs/ft_fopen.o ./objs/ft_putnbr_fd.o ./objs/ft_fclose.o ./objs/ft_putstr_fd.o ./objs/arg_table.o ./objs/printf_internal.o ./objs/ft_printf.o ./objs/parse.o ./objs/ft_gnl.o ./objs/ft_fwrite.o ./objs/trigo.o ./objs/vec_div.o ./objs/vec_mul.o ./objs/vec_mod.o ./objs/ft_noise2.o ./objs/wrap.o ./objs/ft_frand.o ./objs/lerp.o ./objs/ft_max.o ./objs/normalize.o ./objs/ft_is_prime.o ./objs/ft_matrix.o ./objs/ft_min.o ./objs/abs.o ./objs/ceil.o ./objs/distance.o ./objs/ft_rand_circle.o ./objs/smoothstep.o ./objs/frac.o ./objs/ft_dist_line.o ./objs/vec_init.o ./objs/clamp.o ./objs/ft_magnitude.o ./objs/ft_isrange.o ./objs/vec_add.o ./objs/rotate.o ./objs/ft_map.o ./objs/ft_pow.o ./objs/dot.o ./objs/vec_scale.o ./objs/vec_sub.o ./objs/cross.o ./objs/ft_lstsize.o ./objs/ft_lstclear.o ./objs/ft_lstnew.o ./objs/ft_lstsort.o ./objs/ft_lstiter.o ./objs/ft_lsttoarray.o ./objs/ft_lstadd_front.o ./objs/ft_lstadd_back.o ./objs/ft_lstfind.o ./objs/ft_lstlast.o ./objs/ft_lstremoveif.o ./objs/ft_lstmap.o ./objs/ft_lstdelone.o ./objs/ft_lstremove.o ./objs/ft_dupsplit.o ./objs/ft_strgetindex.o ./objs/ft_strtrim.o ./objs/ft_freesplit.o ./objs/ft_strncmp.o ./objs/ft_striteri.o ./objs/ft_strchr.o ./objs/ft_splitlen.o ./objs/ft_strnstr.o ./objs/ft_strjoin.o ./objs/ft_split.o ./objs/ft_strlcpy.o ./objs/ft_strmapi.o ./objs/ft_str_append.o ./objs/ft_str_toupper.o ./objs/ft_strnchr.o ./objs/ft_strlcat.o ./objs/ft_strcmp.o ./objs/ft_tolower.o ./objs/ft_strdup.o ./objs/ft_strerror.o ./objs/ft_str_tolower.o ./objs/ft_strlen.o ./objs/ft_substr.o ./objs/ft_strcat.o ./objs/ft_strrchr.o ./objs/ft_toupper.o ./objs/pad.o
