...
void	clk_diff(t_time *t1, t_time *t2, long *sec, long *nsec)
{
    long        s;
    long        n;
...
static char *
clk_format(long sec, long subsec, char *buffer, U64 buflen, const char *fmt)
{
...
string	clk_elapsed_ms(t_clock *clk, string buffer, U64 buflen)
{
    long sec;
    long nsec;
...
string clk_elapsed_us(t_clock *clk, string buffer, U64 buflen)
{
    long sec;
    long nsec;
...
string clk_elapsed_ns(t_clock *clk, string buffer, U64 buflen)
{
    long sec;
    long nsec;
...
string clk_fmt_elapsed_str(t_clock *clk)
{
    if (clk->buffer[0] == '\0')
