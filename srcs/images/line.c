...
/*   Updated: 2025/02/23 22:27:56 by reclaire         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
FUNCTION_HOT void ft_draw_line_bound(t_image *img, t_iv2 p1, t_iv2 p2, t_color col, t_iv4 bound)
{
	S32 width;
	S32 height;
...
{
	ft_draw_line_bound(img, p1, p2, col, ivec4(0, 0, img->size.x, img->size.y));
}

FUNCTION_HOT void ft_draw_line_bound2(t_image *img, t_iv2 p1, t_iv2 p2, t_color col, t_iv4 bound)
{
	t_color *addr;
	S32 width;
	S32 height;
...
{
	ft_draw_line_bound2(img, p1, p2, col, ivec4(0, 0, img->size.x, img->size.y));
}
